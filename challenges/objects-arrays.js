...
const contactInfo = graduates.map((e) => {
...
const uni = graduates.filter((e) => {
  return e.university.includes("Uni");
});
...
*/
const animalNames = zooAnimals.map((e) => {
  return { name: e.animal_name, scientific: e.scientific_name };
});
...
const lowerCase = zooAnimals.map((e) => {
...
*/
const largerPopulation = zooAnimals.filter((e) => {
